...
Point(30, 15) });
 ...
 file.DropDownItems.AddRange(new ToolStripItem[] { newForm, dialog, 
exit });
 menu.Items.Add(file);
 Controls.Add(menu);
 MainMenuStrip = menu;
